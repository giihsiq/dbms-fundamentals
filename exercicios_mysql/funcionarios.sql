...
/* Exercícios - Baseado em performance */
/* Analisando número de registros no banco, com base em cada departamento */
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS GROUP BY DEPARTAMENTO;

/* 1) Busque todos os registros de funcionários que trabalhem no departamento de filmes ou departamento de roupas */
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS WHERE DEPARTAMENTO = 'Filmes' OR DEPARTAMENTO = 'Roupas' GROUP BY DEPARTAMENTO;
SELECT * FROM FUNCIONARIOS WHERE DEPARTAMENTO = 'Filmes' OR DEPARTAMENTO = 'Roupas';

/* 2) O gestor de marketing pediu para enviar uma lista de todas as funcionárias que trabalham no departamento de filmes ou lar. Ele necessita
      enviar um email para os colaboradores desses dois setores. */
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS WHERE DEPARTAMENTO = 'Filmes' OR DEPARTAMENTO = 'Lar' GROUP BY DEPARTAMENTO;
SELECT * FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'Lar' AND SEXO = 'Feminino') OR (DEPARTAMENTO = 'Filmes' AND SEXO = 'Feminino');

/* 3) Busque todos os registros de funcionários do sexo masculino, ou que trabalhem no setor Jardim. */
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS WHERE SEXO = 'Masculino' GROUP BY DEPARTAMENTO;
